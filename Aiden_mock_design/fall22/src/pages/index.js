...
const IndexPage = () => {
  ...
  const handleTag = (event) => {
    ...
    const tagsArray = input.split('#').filter((tag) => tag.trim() !== '');
    setTags(tagsArray);
    ...
    <main>
      ...
      <div className="w-full bg-white shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar h-[1400px]">
        ...
        <div className="flex-1 px-2">
            ...
            <div key={index}>
              ...
              <div className="mb-6 pt-4 w-[1000px]">
                <div className="mr-[50px] ml-[30px]">
                  <div className='flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-easel3-fill mr-[2px]" viewBox="0 0 16 16">
                ...
                <div className="mr-[50px] ml-[30px]">
                  <div className='flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-vector-pen mr-[2px]" viewBox="0 0 16 16">
                ...
                <div className="mr-[50px] ml-[30px]">
                  <div className='flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar-check-fill mr-[2px]" viewBox="0 0 16 16">
                ...
                <div className="mr-[50px] ml-[30px]">
                  <div className='flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-download mr-[2px]" viewBox="0 0 16 16">
                ...
                <div className="mr-[50px] ml-[30px]">
                  <div className='flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-arrow-up-fill mr-[2px]" viewBox="0 0 16 16">
                ...
                <div className="mr-[50px] ml-[30px] mt-[15px]">
                  <div className='flex'>
                    ...
                    <label htmlFor="input-group-1" className="block mb-2 text-sm font-medium text-gray-900">Tag</label>
                    <svg
                      className='ml-[2px]'
                      width="12px"
                      height="12px"
                  ...
                  <div>
                    <input type="text" name="tags" onChange={handleTag} className="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                    <ul className="flex flex-wrap">
                      {tags.map((tag) => (
                        <li key={tag} className="mt-[10px] bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                          #{tag}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="flex justify-end mr-[50px] ml-[30px]">
            <button className="bg-[#071d49] text-white py-2 px-4 rounded-lg">Submit</button>
          </div>
